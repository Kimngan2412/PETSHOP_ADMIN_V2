...
const FileUploaderMultiple = ({ value, onChange }: any) => {
  ...
  useEffect(() => {
    const convertImageUrlToFile = async (files: any) => {
      ...
      for (const file of files) {
        const imageUrl = `https://kimngan2412-petshop.onrender.com/${file?.url}`;
        try {
  ...
  return (
    <Fragment>
      {/* <div>
        <img src="https://kimngan2412-petshop.onrender.com/uploads/images-1685593894816-792129722.jpg" alt="" />
      </div> */}
